...
def build_calibration(observations_path, weather_path, output_path, site="Balcarce",
                      coverage=10.0, w_max=10.0, source_metadata_path=None):
    ...
    profile.update({
        ...
        "limitations": [
            ...
            "Se conservan el decaimiento Weibull, la extinción de la cohorte y la referencia histórica local de Balcarce.",
...
def main():
    ...
    parser.add_argument("--observations", type=Path, default=ROOT / "data/calibration/balcarce_2026_counts.csv")
    parser.add_argument("--weather", type=Path, default=ROOT / "data/calibration/balcarce_2026_weather.csv")
    parser.add_argument("--output", type=Path, default=ROOT / "data/calibration/balcarce_2026.json")
    parser.add_argument("--source-metadata", type=Path, default=ROOT / "data/calibration/balcarce_2026_source.json")
    parser.add_argument("--site", default="Balcarce")
