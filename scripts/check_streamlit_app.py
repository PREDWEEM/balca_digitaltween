"""Visita pública de Balcarce; comprueba la interfaz, no sólo una respuesta HTTP.
...
APP_URL = "https://jzthpzmfwwtom44dsvkjapp.streamlit.app/"
HEADING = "Gemelo Digital · Lolium Balcarce"
            ...
            while time.monotonic() - started < MAX_WAIT_SECONDS:
                ...
                if ready:
                    if ready_since is None:
                        ...
                        return f"Balcarce operativo: indicadores y gráfico cargados ({seconds} s)."
                else:
                    ready_since = None
