    ...
    if "Calibracion_Aplicada" in df and df["Calibracion_Aplicada"].any():
        figure.add_trace(
            go.Scatter(
                ...
                name="Calibración Balcarce", line=dict(color="#9260bd", width=2),
            ),
            secondary_y=False,
        )
    figure.add_trace(
...
st.markdown(
    ...
    <div class="hero">
      ...
      con perfil concentrado, proyección a 7 días y simulación de escenarios.</p>
    </div>
    """,
    unsafe_allow_html=True,
)
...
if reference_campaigns < 3:
    st.info(
        "La normalización parcial utiliza la referencia local Balcarce disponible "
        f"(n={reference_campaigns} campaña). Los percentiles históricos deben "
        "considerarse preliminares hasta incorporar más campañas independientes."
    )
    ...
    audit_summary = pd.DataFrame(
        {
            ...
            "Valor": [
                ...
                f"Balcarce; n={reference_campaigns} campaña(s)",
